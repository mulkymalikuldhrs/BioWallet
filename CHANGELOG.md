...
- **Dependency Upgrades**: Upgraded `ethers` to v6.16.0+ and `next` to v15.1.7 across all workspaces.
...
### Fixed
- Fixed build errors in `apps/web` related to Next.js 16/Turbopack compatibility by pinning to v15.1.7.
