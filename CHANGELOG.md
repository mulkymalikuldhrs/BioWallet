...
- **Dependency Upgrades**: Upgraded `ethers` to v6.16.0+, `next` to v15.1.7, and `react` to v19.0.0 across all workspaces.
...
- **Security Enhancements**: Implemented WebAuthn PRF extension support for high-entropy key derivation in the web app, with a secure local secret fallback.
