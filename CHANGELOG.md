...
- **Dependency Upgrades**: Upgraded `ethers` to v6.16.0+, `next` to v16.2.4, and `react` to v19.2.5 across all workspaces.
...
### Fixed
- Fixed build errors in `apps/web` by upgrading to React 19 as required by Next.js 16.
