...
[![Version](https://img.shields.io/badge/version-3.1.0-2E9EF7?style=for-the-badge&logo=semver)](https://github.com/mulkymalikuldhrs/BioWallet)
[![Status](https://img.shields.io/badge/status-Research_Phase-yellow?style=for-the-badge)](https://github.com/mulkymalikuldhrs/BioWallet)
...
### 🔐 v3.1.0 — Security Hardening & Maintenance

This release includes critical security fixes and maintenance improvements:

- **Fixed deterministic wallet generation**: Removed `Date.now()` from salt; keys are now derived deterministically from device-specific secrets and biometric data
...
| ![Next.js](https://img.shields.io/badge/Next.js-15.1.7-000000?logo=next.js) | Web App |
| ![Express](https://img.shields.io/badge/Express-5.0.0-000000?logo=express&logoColor=white) | Backend API |
| ![Prisma](https://img.shields.io/badge/Prisma-6.19.3-2D3748?logo=prisma) | ORM |
| ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-15-4169E1?logo=postgresql&logoColor=white) | Database |
| ![TypeScript](https://img.shields.io/badge/TypeScript-6.0.3-3178C6?logo=typescript&logoColor=white) | Type Safety |
...
> **Important Note on Wallet Recovery:** This implementation uses device-specific secrets and salts stored in the device's secure enclave. If the device is lost or the app is uninstalled, the wallet cannot be recovered using biometrics alone. This is an early-stage research project.
>
